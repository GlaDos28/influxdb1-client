...
// use github.com/glados28/influxdb1-client/v2 instead.
package client // import "github.com/glados28/influxdb1-client"
...
import (
	...
	"github.com/glados28/influxdb1-client/models"
)
...
func (c *Client) QueryContext(ctx context.Context, q Query) (*Response, error) {
	...
	defer func() {
		io.Copy(ioutil.Discard, resp.Body) // https://github.com/glados28/influxdb1-client/issues/58
		resp.Body.Close()
	}()
